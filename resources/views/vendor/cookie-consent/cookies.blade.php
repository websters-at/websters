            ...
            <form action="{{ route('cookieconsent.accept.configuration') }}" method="post" class="cookies__customize">
                ...
                <div class="cookies__sections">
                    ...
                    <div class="cookies__section">
                        ...
                        <a href="#cookies-policy-{{ $category->key() }}" class="cookies__details !text-brand-dark !font-semibold">@lang('cookieConsent::cookies.details.more')</a>
                    </div>
                    @endforeach
                </div>
                <div class="cookies__save">
                    <button type="submit" class="btn btn-primary w-full font-poppins font-semibold">@lang('cookieConsent::cookies.save')</button>
                </div>
            </form>
        </div>
    </div>
