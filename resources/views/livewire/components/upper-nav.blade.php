        ...
        <div class="flex items-center justify-center gap-x-8 md:gap-x-10 py-2">
            ...
            <div class="flex items-center gap-x-1.5">
                <a href="tel:+4367763177763"
                   ...
                   class="flex items-center justify-center gap-x-1.5 cursor-pointer text-sm text-white font-bold font-poppins py-1 min-w-[28px] min-h-[28px]">
            ...
            <div class="flex items-center gap-x-1.5">
                <a href="https://www.facebook.com/profile.php?id=61569509807621"
                   ...
                   title="Facebook"
                   class="flex items-center justify-center gap-x-1 cursor-pointer text-sm text-white font-medium font-poppins py-1 min-w-[28px] min-h-[28px]">
                    <x-icon name="fab.facebook-f" class="text-white w-3"/>
                </a>
            </div>
