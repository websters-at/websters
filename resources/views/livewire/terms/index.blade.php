...
<section class="mt-32 lg:mt-16 mb-8 lg:mb-4 lg:pt-20 relative" id="agb">
            ...
            <div class="mt-4 space-y-4">
                ...
                <div class="group rounded-2xl border border-slate-200 bg-white/60 hover:border-slate-300 transition-all">
                    <div class="p-5 sm:p-6 space-y-2 text-sm font-poppins text-slate-600">
                        ...
                        <p>
                            <span class="font-semibold">5.3</span>
                ...
                <div class="group rounded-2xl border border-slate-200 bg-white/60 hover:border-slate-300 transition-all">
                    <div class="p-5 sm:p-6 space-y-2 text-sm font-poppins text-slate-600">
                        ...
                        <p>
                            <span class="font-semibold">6.2</span>
                ...
                <div class="group rounded-2xl border border-slate-200 bg-white/60 hover:border-slate-300 transition-all">
                    <div class="p-5 sm:p-6 space-y-2 text-sm font-poppins text-slate-600">
                        ...
                        <p>
                            <span class="font-semibold">8.1</span>
                ...
                <div class="group rounded-2xl border border-slate-200 bg-white/60 hover:border-slate-300 transition-all">
                    <div class="p-5 sm:p-6 space-y-2 text-sm font-poppins text-slate-600">
                        ...
                        <p>
                            <span class="font-semibold">9.1</span>
                        ...
                        <p>
                            <span class="font-semibold">9.3</span>
                ...
                <div class="group rounded-2xl border border-slate-200 bg-white/60 hover:border-slate-300 transition-all">
                    <div class="p-5 sm:p-6 space-y-2 text-sm font-poppins text-slate-600">
                        ...
                        <p>
                            <span class="font-semibold">10.4</span>
                ...
                <div class="group rounded-2xl border border-slate-200 bg-white/60 hover:border-slate-300 transition-all">
                    <div class="p-5 sm:p-6 space-y-2 text-sm font-poppins text-slate-600">
                        ...
                        <p class="pl-4">
                            ...
                            Insolvenzverfahren eröffnet ist, bestehen und dieser auf Begehren von Stevan Vlajic weder
                            Vorauszahlungen leistet noch vor Leistung von Stevan Vlajic eine taugliche Sicherheit leistet
                ...
                <div class="group rounded-2xl border border-slate-200 bg-white/60 hover:border-slate-300 transition-all">
                    <div class="p-5 sm:p-6 space-y-2 text-sm font-poppins text-slate-600">
                        ...
                        <p>
                            <span class="font-semibold">13.1</span>
                        ...
                        <p>
                            <span class="font-semibold">13.2</span>
