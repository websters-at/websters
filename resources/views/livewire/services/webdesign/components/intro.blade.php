...
>
    ...
    <div class="max-w-7xl mx-auto px-4 xl:px-4 flex flex-col items-start">
        <div
        ...
        >
            Hier erfährst du alles, was du über unseren Webdesign-Service wissen musst. Wir erklären dir transparent und verständlich, wie wir arbeiten und was du von uns erwarten kannst.</p>

        <div class="mt-4 flex flex-wrap items-center justify-center gap-3 lg:mt-5">
