...
?>
<section class="relative overflow-hidden" id="website">

    <!-- Background Blur -->
    <div class="absolute inset-0 -z-10 opacity-70 pointer-events-none">
    ...
    <div class="max-w-7xl mx-auto px-4 xl:px-0">
        <div class="grid gap-y-8 md:px-4 lg:grid-cols-2 lg:items-center lg:gap-x-12 lg:gap-y-0 lg:px-8">
            ...
            <div class="flex flex-col items-start sm:items-center sm:text-center lg:items-start lg:text-left order-2 lg:order-1">
                ...
                <!-- HEADLINE (same style as About) -->
                <div
                    class="mt-8 bg-gradient-to-b from-[#002a42] to-slate-600 bg-clip-text
                    text-2xl font-poppins font-semibold text-transparent
                    sm:w-4/5 md:w-3/5 lg:mt-9 lg:w-11/12 lg:text-4xl lg:leading-tight xl:w-3/4"
                >
                ...
                <p class="mt-4 text-sm font-poppins text-slate-600 sm:w-1/2 lg:w-11/12">
                    In nur <span class="font-semibold text-primary">2-5 Wochen</span> ist deine Website bereit. Technisch sauber,
                    optisch stark und optimiert, um aus Besuchern zufriedene Kunden zu machen.
                </p>
