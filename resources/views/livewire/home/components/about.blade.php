        ...
        <div class="grid gap-y-8 md:px-4 lg:grid-cols-2 lg:items-center lg:gap-x-16 lg:px-8">
            ...
            >
                ...
                <h1
                    ...
                    text-transparent sm:w-4/5 md:w-3/5 lg:mt-9 lg:w-11/12 lg:text-4xl lg:leading-tight xl:w-3/4"
                >
                    Arbeite mit unserem engagierten Entwicklerteam
                </h1>

                <p
                    class="mt-4 text-sm font-poppins text-slate-600 sm:w-1/2 lg:w-11/12"
                >
