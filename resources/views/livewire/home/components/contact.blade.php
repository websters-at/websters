        ...
        >
            ...
            >
                ...
                <p class="mt-4 text-sm font-medium text-slate-600 sm:w-1/2 lg:w-11/12">
                    ...
                    eine Zusammenarbeit planst oder Fragen hast. Wir helfen dir gern weiter
                    und bearbeiten deine Anfrage schnellstmöglich. <br>
                    Mit freundlichen Grüßen – <strong>Dein Websters Team</strong>
                </p>
            </div>
            ...
            >
                <div class="flex flex-col gap-y-3 lg:gap-y-5">
                    <div class="grid gap-y-3 lg:grid-cols-2 lg:gap-x-3 lg:gap-y-0">
                        ...
                        <div class="flex w-full flex-col fade-up" :class="{ 'show': show }" style="transition-delay:.3s">
                            <x-input
                                required="true"
                                label="Name"
                                wire:model="name"
                        ...
                        <div class="flex w-full flex-col fade-up" :class="{ 'show': show }" style="transition-delay:.35s">
                            <x-input
                                label="Firma"
                                wire:model="company"
                                type="text"
                    ...
                    <div class="flex w-full flex-col fade-up" :class="{ 'show': show }" style="transition-delay:.4s">
                        <x-input
                            label="Email-Adresse"
                            required="true"
                            wire:model="email"
                    ...
                    <div class="flex flex-col fade-up" :class="{ 'show': show }" style="transition-delay:.45s">
                        <x-textarea
                            label="Nachricht"
                            wire:model="message"
                            rows="5"
