    ...
    <div class="max-w-7xl mx-auto px-4 xl:px-0">
        ...
        >
            <article class="flex flex-col">
                ...
                >
                    <img
                        class="h-full w-full rounded-2xl object-cover lg:h-full lg:rounded-3xl"
                    ...
                    <div class="mt-3 flex flex-wrap items-center gap-2 lg:mt-4">
                        ...
                        >
                            <svg
                                ...
                                xmlns="http://www.w3.org/2000/svg"
                            >
                                <g clip-path="url(#clip0_1502_25447)">
                                    <path
                                        fill-rule="evenodd"
                                        clip-rule="evenodd"
            ...
            <article class="flex flex-col">
                ...
                >
                    <img
                        class="h-44 h-full rounded-2xl object-cover lg:h-full lg:rounded-3xl"
            ...
            <article class="flex flex-col">
                ...
                >
                    <img
                        class="h-44 w-full rounded-2xl object-cover lg:h-52 lg:rounded-3xl"
