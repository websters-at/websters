<section class="lg:pt-24 pt-8 pb-12 lg:pb-16" id="team">
    <div class="max-w-7xl mx-auto px-4 xl:px-0">
        ...
        >
            <article class="flex flex-col">
                ...
                >
                    <img
                        ...
                        alt="Stevan V. - Webdesigner & Software Engineer bei Websters Linz"
                        title="Stevan V. - Webdesign & Entwicklung bei Websters Linz"
                        loading="lazy"
                        width="400"
                        height="400"
                    />
            ...
            <!-- Wiederhole das gleiche Schema für Michael und Manuel -->
            <article class="flex flex-col">
                <figure
                    class="w-full aspect-square rounded-2xl lg:rounded-3xl lg:shadow-[0_2px_10px_0px_rgba(0,0,0,0.05)] overflow-hidden"
                >
                    <img
                        ...
                        alt="Michael R. - DevOps Engineer & Cloud Architect bei Websters Linz"
                        title="Michael R. - DevOps & Cloud Architektur bei Websters Linz"
                        loading="lazy"
                        width="400"
                        height="400"
                    />
            ...
            <article class="flex flex-col">
                ...
                >
                    <img
                        ...
                        alt="Manuel P. - Webentwickler & Software Engineer bei Websters Linz"
                        title="Manuel P. - Webentwicklung & DevOps bei Websters Linz"
                        loading="lazy"
                        width="400"
                        height="400"
                    />
                ...
                <div class="flex flex-col items-start p-2 lg:px-0 lg:pb-0 lg:pt-4">
                    <div class="font-semibold text-neutral-700 md:text-lg lg:text-xl" itemprop="name">
                        Manuel P.
                    </div>
                    <p class="mt-1 hidden font-medium text-neutral-500 lg:block" itemprop="jobTitle">
                        Webentwicklung, Software Engineer, Dev-Ops Engineer
                    </p>
                    <p class="mt-0.5 text-sm font-medium text-neutral-500 lg:hidden" itemprop="jobTitle">
                        Webentwicklung, Software Engineer, Dev-Ops Engineer
                    </p>
                    <div class="mt-3 flex flex-wrap items-center gap-2 lg:mt-4">
                        <a
