...
<section class="mt-12 bg-slate-50 py-8 md:py-12 lg:py-16">
    ...
    <div class="max-w-7xl mx-auto px-4 xl:px-0">
        ...
        >
            ...
            >
                ...
                <p class="mt-4 text-sm font-poppins font-medium text-slate-600 sm:w-1/2 lg:w-11/12">
                    Wir freuen uns darauf, von dir zu hören. Egal ob Anfrage, Projektidee
                    oder Kooperation. Wir stehen dir gerne zur Verfügung.
                </p>
                <div
                    class="mt-8 flex flex-col flex-wrap gap-2 text-sm font-medium text-neutral-500 lg:mt-9"
                >
                    <a href="tel:+43 677 63177763" title="Anrufen" target="_blank">+43 677 63177763</a>
                    <a href="mailto:office@websters.at" title="Email Schreiben" target="_blank">office@websters.at</a>
                    Libellenweg 13, 4209 Außertreffling
                </div>
                <div class="mt-8 flex flex-wrap items-center gap-4 lg:mt-9">
                    <a href="https://github.com/websters-at" title="Github" target="_blank" class="group">
                    ...
                    <a href="https://www.instagram.com/websters.at/" title="Instagram" target="_blank" class="group">
                        <div class="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white shadow-sm transition-all group-hover:border-[#4bc8e7] group-hover:shadow-md">
                    ...
                    <a href="https://www.instagram.com/websters.at/" title="Facebook" target="_blank" class="group">
                        <div class="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white shadow-sm transition-all group-hover:border-[#4bc8e7] group-hover:shadow-md">
                    ...
                    <a href="tel:+43 677 63177763" title="Telefon" target="_blank" class="group">
                        <div class="flex h-10 w-10 items-center justify-center rounded-full border border-slate-200 bg-white shadow-sm transition-all group-hover:border-[#4bc8e7] group-hover:shadow-md">
            ...
            <iframe
                class="h-52 w-full rounded-3xl lg:h-full"
